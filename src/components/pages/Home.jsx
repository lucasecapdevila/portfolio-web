  ...
  return (
    <main className="h-screen">
      <div className="relative flex flex-col md:flex-row h-full">
        ...
        <img
          src={imagen}
          className="absolute inset-0 size-64 md:size-80 xl:size-96 rounded-full object-cover mx-auto my-auto transform -translate-x-0 -translate-y-3/4 md:-translate-x-1/3 md:-translate-y-1 xl:-translate-x-1/2"
          alt="lucasecapdevila" />
        <div className="w-full md:w-1/2 xl:w-3/5 flex flex-col justify-center items-center md:items-start mt-10 md:mt-0 bg-whiteBg">
          ...
          <div className="w-full md:w-2/3 md:ms-20 xl:ms-56 px-4 xl:px-0 md:px-0 xl:flex justify-start">
            <a href={pdf} download className="w-full md:w-2/3 xl:w-2/4 md:ms-16 px-4 xl:px-0 mt-4 justify-center">
              <Button pill outline className="cvBtn enlaces w-full border-4 border-reactLightBlue p-0 text-reactLightBlue font-bold">Descargar CV</Button>
            </a>
