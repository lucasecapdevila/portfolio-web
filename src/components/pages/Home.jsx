        ...
        <div className="w-full md:w-1/2 xl:w-3/5 flex flex-col grow gap-2 justify-center items-center md:items-start mt-8 md:mt-0 bg-whiteBg">
          ...
          <div className="w-full md:w-2/3 md:ms-20 xl:ms-56 px-4 xl:px-0 md:px-0 xl:flex justify-start">
            <a href={pdf} download className="w-full md:w-2/3 xl:w-2/4 md:ms-16 px-4 xl:px-0 mt-4 justify-center">
              <Button pill outline className="cvBtn w-full border-4 border-textDarkColor p-0 text-textDarkColor font-bold">Descargar CV</Button>
            </a>
            <Link className="hidden md:inline w-full md:w-2/3 xl:w-2/4 md:ms-16 xl:ms-10 px-4 mt-4 justify-center">
              <Button to="/contacto" pill className="contactoBtn w-full bg-textDarkColor border-4 text-whiteBg font-bold">Contacto</Button>
            </Link>
          </div>
        </div>
      </div>
