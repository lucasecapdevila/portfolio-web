  ...
  return (
    <main className="min-h-[90vh] md:h-screen px-4 pt-10 pb-5">
      <div className="flex flex-col justify-center items-center gap-4">
        ...
        <p className="text-textBlack text-md md:px-8 md:text-lg">A continuación te presento algunos de los proyectos que he creado a partir de HTML y más recientemente, con React.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 justify-items-center gap-4 mt-10">
